    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_method', models.CharField(choices=[('IS', 'In Store'), ('HD', 'Home Delivery'), ('DD', 'Degital Delivery')], help_text='Required', max_length=255, verbose_name='delivery method')),
