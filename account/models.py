...
# this allows you to translate things into different languages
...
class UserBase(AbstractBaseUser, PermissionsMixin):
    ...
    def email_user(self, subject, message):
        send_mail(subject, message, 'xqfqhu@gmail.com',
...
class Address(models.Model):
    ...
    customer = models.ForeignKey(
        UserBase, related_name='customer', on_delete=models.CASCADE)
