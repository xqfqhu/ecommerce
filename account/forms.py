    ...
    def clean_email(self):
        ...
        if not u:
            raise forms.ValidationError(
                'Unfortunately, we cannnot find that email address')
        else:
            return email
...
class AddressForm(forms.ModelForm):
    ...
    class Meta:
        model = Address
        fields = ['full_name', 'phone', 'postcode', 'address_line',
                  'address_line2', 'town_city', 'country', 'state']
