...
urlpatterns = [
    ...
    path('password_reset/password_reset_email_confirm/',
         views.passwordResetEmailConfirm, name='password_reset_email_confirm'),
    path('password_reset_confirm/MjQ/set-password/passord_reset_complete/',
         views.passwordResetComplete, name='password_reset_complete'),
    path('add_address/', views.add_address, name='add_address'),
    path('addresses/', views.view_address, name='addresses'),
    path('delete_address/<slug:address_id>',
         views.delete_address, name='delete_address'),
    path('edit_address/<slug:address_id>',
         views.edit_address, name='edit_address'),
    path('set_default/<slug:address_id>',
